  ...
  contacts.forEach(contact => {
    ...
    <div class="card mt-1 mb-1 ${contact.emergencyContact ? 'emergency-contact' : ''}">
      ...
      <div class="d-flex space-between">
        ...
        <button type="button" class="action fa fa-trash text-danger" onclick="removeContact('${contact.id}')">
        </button>
      </div>
    </div>
    `
...
function contactForm() {
  document.getElementById("newContactForm").classList.toggle("hidden")
